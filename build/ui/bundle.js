...
// Word information
var WCHARS = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ?!.,;"\'()[]{}'.split('');
var WDELIM = [' ', 'Enter', 'Tab', 'Backspace'];
...
function fadeAway() {
    ...
    add(' ');
    // Fade effect
    $word.delay(FADE_DELAY).fadeOut(FADE_TIME);
    // Start anew
    $word = null;
}
...
(0, _jquery2.default)(function () {
    ...
    (0, _jquery2.default)(document).keydown(function (event) {
        ...
        if (_lodash2.default.includes(WCHARS, event.key)) add(event.key);
